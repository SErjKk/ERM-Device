...
public class StatisticController {
    ...
    @FXML
    private Button leave_button;     //кнопка возврата
    @FXML
    ...
    void initialize() {
        ...
        //меню + привязка клавиш
        {
            ...
            MenuItem helpItem1 = new MenuItem("* Как много кто-то потратил электроэнергии...");
            MenuItem helpItem2 = new MenuItem("* Серёжа недоволен :(");
            MenuItem helpItem3 = new MenuItem("* Ты опять не выключил свет перед уходом?");
